...
try {
    ...
    // Insert data (ignore errors if already exists)
    $pdo->exec("
        INSERT IGNORE INTO `invoices` (`id`, `client_id`, `number`, `issue_date`, `value`, `status`, `file_url`, `file_type`, `notes`, `created_at`) VALUES 
